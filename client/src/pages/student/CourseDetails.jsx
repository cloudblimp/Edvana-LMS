...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateTotalLecture, currency } = useContext(AppContext)
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* right column */}
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] max-h-[750px]'>
          {
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center gap-3 pt-2'>
              ...
              <p className='text-lg text-gray-500'><s>{currency}{courseData.coursePrice}</s></p>
