            ...
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="number"
                    min={0} // ensures only positive numbers can be typed
                    className="mt-1 block w-full border rounded py-1 px-2"
                    value={lectureDetails.lectureDuration}
                    onChange={(e) =>
                      setLectureDetails({
                        ...lectureDetails,
                        lectureDuration: Math.max(0, Number(e.target.value)), // force >= 0
                      })
                    }
                  />
                </div>
                ...
                <button
                  className="w-full bg-blue-400 text-white py-2 rounded mb-2"
                  onClick={addLecture}
                  type="button"
                >
                  Add
